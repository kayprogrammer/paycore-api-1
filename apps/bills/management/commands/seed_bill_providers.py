...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # MTN Data Packages
        mtn_packages = [
            {'name': '1GB Daily', 'code': 'MTN-1GB-D', 'amount': Decimal('300'), 'validity': '1 day', 'is_popular': False},
            {'name': '2GB Weekly', 'code': 'MTN-2GB-W', 'amount': Decimal('500'), 'validity': '7 days', 'is_popular': True},
            {'name': '5GB Monthly', 'code': 'MTN-5GB-M', 'amount': Decimal('1500'), 'validity': '30 days', 'is_popular': True},
            {'name': '10GB Monthly', 'code': 'MTN-10GB-M', 'amount': Decimal('2500'), 'validity': '30 days', 'is_popular': True},
            {'name': '20GB Monthly', 'code': 'MTN-20GB-M', 'amount': Decimal('4000'), 'validity': '30 days', 'is_popular': False},
            {'name': '40GB Monthly', 'code': 'MTN-40GB-M', 'amount': Decimal('10000'), 'validity': '30 days', 'is_popular': False},
        ]
        ...
        # DSTV Packages
        dstv_packages = [
            {'name': 'DSTV Padi', 'code': 'DSTV-PADI', 'amount': Decimal('2500'), 'validity': '1 month', 'is_popular': False},
            {'name': 'DSTV Yanga', 'code': 'DSTV-YANGA', 'amount': Decimal('3500'), 'validity': '1 month', 'is_popular': False},
            {'name': 'DSTV Confam', 'code': 'DSTV-CONFAM', 'amount': Decimal('5300'), 'validity': '1 month', 'is_popular': True},
            {'name': 'DSTV Compact', 'code': 'DSTV-COMPACT', 'amount': Decimal('10500'), 'validity': '1 month', 'is_popular': True},
            {'name': 'DSTV Compact Plus', 'code': 'DSTV-COMPACT-PLUS', 'amount': Decimal('16600'), 'validity': '1 month', 'is_popular': True},
            {'name': 'DSTV Premium', 'code': 'DSTV-PREMIUM', 'amount': Decimal('24500'), 'validity': '1 month', 'is_popular': False},
        ]
        ...
        # GOtv Packages
        gotv_packages = [
            {'name': 'GOtv Smallie', 'code': 'GOTV-SMALLIE', 'amount': Decimal('1100'), 'validity': '1 month', 'is_popular': False},
            {'name': 'GOtv Jinja', 'code': 'GOTV-JINJA', 'amount': Decimal('2250'), 'validity': '1 month', 'is_popular': True},
            {'name': 'GOtv Jolli', 'code': 'GOTV-JOLLI', 'amount': Decimal('3300'), 'validity': '1 month', 'is_popular': True},
            {'name': 'GOtv Max', 'code': 'GOTV-MAX', 'amount': Decimal('4850'), 'validity': '1 month', 'is_popular': False},
        ]
        ...
        self.stdout.write(self.style.WARNING(f'   Update provider_code values based on your payment gateway.'))
